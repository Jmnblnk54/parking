...
import parkingWhite from "../../../assets/icons/parkingWhite.svg";
    ...
    <Wrapper>
      {history?.location?.pathname.includes("host") ? (
        <div className="bg-icon">
          <img
            className="icon"
            src="/static/media/house.5f69030ca3bb055477aeff7736e5d384.svg"
            alt=""
          />
          <div className="left-container-host">
            <h2>
              ...
              <span className="logo-btw-heading">
                <img src={parkingWhite} alt="parkingWhite.svg" />
              </span>
              ‘n!
            </h2>
        ...
        <div className="bg-icon">
          <img
            className="icon-car"
            src="/static/media/car.b5f95c2f005c9f2cb5c7d4d946bf17fc.svg"
            alt=""
          />
